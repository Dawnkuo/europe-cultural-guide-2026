...
export const cologneParisGuideContent = defineGuideContent({
  'museum-ludwig': {
    ...
    practical: [
      '最新详细行程为10月4日14:00–16:00，未订、可现场购票；12:55航班落地至参观仅65分钟，进城及行李交接衔接待确认。',
  ...
  hohenzollern: {
    ...
    practical: [
      '最新详细行程为10月4日16:10–16:40，无需门票；从路德维希博物馆约0.4公里、步行约5分钟。',
  ...
  'koln-triangle': {
    ...
    practical: [
      '最新详细行程为10月4日16:50–17:50，按原表现场购票；从霍亨索伦桥约0.8公里、步行约10分钟。',
  ...
  'cologne-cathedral': {
    ...
    practical: [
      '教堂内部票面10:00–17:45有效，南塔与珍宝馆组合票10:00–16:00有效；原表分别安排内部10:00–11:00、南塔11:00–12:00、珍宝馆12:00–13:00。游览安排不等于票面有效窗口。',
  ...
  'cologne-old-town': {
    ...
    practical: [
      '最新详细行程为10月5日13:10–14:00，无需门票；从大教堂珍宝馆约0.5公里、步行约6分钟。',
  ...
  rheinauhafen: {
    ...
    practical: [
      '最新详细行程为10月5日14:25–15:00，无需门票；从老城约1.7公里、步行约20–25分钟。场内介绍不改变原行程顺序。',
  ...
  'chocolate-museum': {
    ...
    practical: [
      '最新详细行程为10月5日15:00–16:45，状态未订；莱茵港同在15:00结束，约6分钟步行尚未体现在时间段之间。',
  ...
  'notre-dame-towers': {
    ...
    practical: [
      '新增三张成人电子票已核实：2026年10月6日09:30登塔，迟到预约取消。登塔票不含圣母院教堂内部，不能把同一票用于两个入口。',
  ...
  seine: {
    ...
    practical: [
      '原表将双塔和河岸共同安排在09:30–16:30；双塔现已订09:30，河岸散步排在其后，未另定起止时刻，不自行扩充世界遗产区游览范围。',
