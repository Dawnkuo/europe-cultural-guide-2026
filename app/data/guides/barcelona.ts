...
export const barcelonaGuideContent = defineGuideContent({
  ...
  'turo-rovira': {
    ...
    practical: [
      '10月2日为周五，室内解释空间不开放；免费不等于全天开放，山体外围与核心考古围区必须区分。',
      '市政府列核心考古围区10月至4月09:00–17:30开放；原表18:20抵达时已过闭门时间，只保留外围步道意向，可通行范围现场确认，不更改原行程时间。',
      '山路、台阶和遗址边缘不平，日落后照明有限；穿防滑鞋并准备独立照明，不依赖手机剩余电量。',
      '不要绕过围栏进入已关闭的炮台遗址；任何临时封闭与管理人员指示优先于历史攻略。',
    ],
    sources: [
      {
  ...
  'santa-maria-mar': {
    ...
    practical: [
      '周一至周六10:00–18:00为收费文化参观，末次入场17:30；原表17:10仍在收费时段，网站已标记未订，不改变原行程时间。',
