...
export const romeVaticanGuideContent = defineGuideContent({
  'vatican-museums': {
    ...
    practical: [
      '备好开门团确认和入场凭证；团体结束后先确认自由参观的交接安排。',
  ...
  'st-peters-basilica': {
    ...
    highlights: [
      ...
      },
      {
        ...
        period: '多时期',
        location: '大殿下方 · Grotte Vaticane',
        image: '/images/reviewed/vatican-necropolis-941805a495.jpg',
        imageAlt: '梵蒂冈墓穴层带壁画天顶的通道与铭文，不是更深处的罗马墓地',
        summary:
          '大殿下方的礼拜堂、通道与教宗墓葬构成梵蒂冈墓穴层；更深处的罗马时代墓地是另一处考古空间，两者不能视为同一游览区域。',
        lookFor:
          '看拱顶、墓碑与礼拜堂如何沿通道展开，再比较此层与上方大殿的关系；本图定位墓穴层，不表示已进入更深的考古墓地。',
        displayNote: '梵蒂冈墓穴层（Grotte Vaticane）不同于下方罗马墓地（Necropoli Vaticana）。后者须单独预约导览，不由现有圣殿或穹顶预约自动包含。',
      },
      {
        title: '米开朗基罗穹顶',
    ...
    sequence: [
      {
        title: '为14:30穹顶入场完成集合和安检',
        body: '二维码邮件明确区分穹顶14:30、圣殿15:30；按VIOLET-LAMBERTINI路线和邮件集合指引办理，不把预约时刻当作开始排安检的时刻。',
      },
      {
        title: '先走穹顶垂直动线',
        body: '按14:30穹顶预约进入；电梯后仍需步行与爬窄梯，内环、夹层和顶部不是同一个平台。',
      },
      {
        title: '顶部看完整城市轴线',
        body: '辨认广场、协和大道与梵蒂冈博物馆方向，再按现场指引下行，衔接15:30圣殿预约。',
      },
      {
        title: '15:30进入圣殿主层',
        body: '含数字语音导览，无导游自由参观；先看右侧《圣殇》，再沿中殿走向交叉部。',
      },
      {
        title: '在交叉部建立上下关系',
      ...
      {
        title: '完成后殿与可开放区域',
        body: '只走当日允许路线，按原表约17:00结束后前往邮局；地下墓穴开放不由穹顶票保证。',
      },
    ],
    practical: [
  ...
  'st-peters-square': {
    ...
    overview:
      '圣彼得广场是贝尼尼为亚历山大七世设计的宗教集会空间：横向椭圆柱廊像双臂包围人群，靠近大教堂的一段梯形前庭又校正立面透视。中央方尖碑早于广场与现圣殿，双喷泉则平衡两侧空间。本次13:30至14:20无需门票，但要依二维码邮件提前完成集合与安检，衔接14:30穹顶和15:30圣殿预约。',
    orientation: [
      {
        title: '椭圆加梯形',
    ...
    spatial: {
      type: 'viewpoints',
      title: '方尖碑、焦点石与双臂柱廊',
      note: '广场停留需衔接14:30穹顶预约；集合和安检按邮件路线办理。',
      stops: [
        '协和大道中轴',
        '中央方尖碑',
        '柱廊焦点石',
    ...
    sequence: [
      ...
      {
        title: '提前转向右侧安检',
        body: '二维码邮件是穹顶14:30、圣殿15:30，不因广场免费开放而低估安检。',
      },
    ],
    practical: [
      '广场停留与进入大教堂分开；进教堂仍需安检，穹顶及圣殿预约使用各自二维码。',
